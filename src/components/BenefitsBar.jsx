                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  gap-24 text-center">
                    <div className="flex gap-4 items-center">
                        <div className="p-3 bg-brand-green/10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" dth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-circle-check-big w-6 h-6 text-brand-green" aria-hidden="true">
                    ...
                    <div className="flex gap-4 items-center">
                        <div className="p-3 bg-[#D4A574]/10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-truck w-6 h-6 text-[#D4A574]" aria-hidden="true">
                    ...
                    <div className="flex gap-4 items-center">
                        <div className="p-3 bg-[#D4A574]/10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-rotate-ccw w-6 h-6 text-[#D4A574]" aria-hidden="true">
                    ...
                    <div className="flex gap-4 items-center">
                        <div className="p-3 bg-brand-green/10 rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shield w-6 h-6 text-brand-green" aria-hidden="true">
